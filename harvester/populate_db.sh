...
# nohup python3 addto_db.py 172.26.128.114 data/historical-bendigo.json historical-bendigo-raw >nohup11.out 2>&1 &
...
nohup python3 addto_db.py 172.26.132.216 data/historical-geelong.json historical-geelong-raw >nohup6.out 2>&1 &
